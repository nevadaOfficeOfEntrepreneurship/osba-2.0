    ...
    return (
      <div className="card">
        <div className="card-body text-muted">
          Select a question on the left to see guidance based on official Nevada sources.
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="card">
      ...
      <div className="card-body">
        <p className="fw-semibold">{faq.shortAnswer}</p>
        <p>{faq.detailedAnswer}</p>

        <div className="mb-3">
          <small className="text-muted">
            Jurisdiction: {faq.jurisdiction} · Topics:{' '}
            {faq.topicTags.join(', ')}
          </small>
        </div>
        ...
        <div className="mb-3 d-flex align-items-center">
          ...
          <button
            ...
            onClick={() => console.log('feedback', faq.id, 'up')}
          >
            👍 Yes
          </button>
          <button
            ...
            onClick={() => console.log('feedback', faq.id, 'down')}
          >
            👎 No
          </button>
        </div>
...
// src/components/AnswerPanel.jsx 2
